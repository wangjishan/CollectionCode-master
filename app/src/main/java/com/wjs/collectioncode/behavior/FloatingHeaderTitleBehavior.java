...
import com.wjs.collectioncode.CollectionCodeApplication;
...
public class FloatingHeaderTitleBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, View child, View dependency) {
        ...
        // background change
        int startColor = CollectionCodeApplication.getAppContext().getResources().getColor(R.color.init_bg_color);
        int endColor = CollectionCodeApplication.getAppContext().getResources().getColor(R.color.end_bg_color);
    ...
    private int getCollapsedHeight() {
        return CollectionCodeApplication.getAppContext().getResources().getDimensionPixelOffset(R.dimen.collapsedTitleHeight);
    }
}
