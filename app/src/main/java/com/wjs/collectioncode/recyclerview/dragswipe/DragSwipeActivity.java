package com.wjs.collectioncode.recyclerview.dragswipe;
...
public class DragSwipeActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        mAdapter = new DragSwipeAdapter(this, mRecyclerView, mData, R.layout.item);
...
//        });
    ...
    class DragSwipeAdapter extends BaseRecylerViewAdapter<String> {


        public DragSwipeAdapter(Context mContext, RecyclerView recyclerView, List<String> mDatas, int mLayoutId) {
